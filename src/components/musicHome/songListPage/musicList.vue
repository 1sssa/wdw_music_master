    ...
    >
      ...
      <div class="songRoot">
        <i
          ...
          style="color: #2098da; cursor: pointer"
          v-show="item.mv != 0"
          @click="toVideoPage(item.mv)"
        ></i>
        <i
          class="iconfont icon-vip-l"
          style="color: #2098da; margin-left: 10px"
          v-show="songsDetail.privileges[index].chargeInfoList[0].chargeType !== 0"
        ></i>
      </div>
      <!-- 播放或暂停音乐动画表情 -->
      <div
        style="font-size: 10px; position: absolute; top: 20px; left: 28px; color: #2098da"
      ...
      <i
        ...
        style="font-size: 10px; position: absolute; top: 2px; left: 28px; color: #2098da"
